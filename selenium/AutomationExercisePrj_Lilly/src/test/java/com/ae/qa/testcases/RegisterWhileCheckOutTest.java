...
public class RegisterWhileCheckOutTest extends TestBase
{
    ...
    public RegisterWhileCheckOutTest()
    {
        super();
    }
    ...
    public void validateAddToCartInProductPage() {
        ...
        loginPageObj = cartPageObj.clickCheckoutWithoutLogin();
    ...
    @Test(priority = 7)
    public void validateProceedCheckout()
    {
       cartPageObj=userHomePageObj.clickCartLink();
    ...
    {
       Assert.assertEquals(checkoutPageObj.checkDeliveryAddress(),true);

    }

    @Test(priority = 9)
    public void validateBillingyAddress()
    {
        Assert.assertEquals(checkoutPageObj.checkBillingAddress(),true);
