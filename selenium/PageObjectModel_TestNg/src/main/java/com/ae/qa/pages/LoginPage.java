...
public class LoginPage extends TestBase {
    ...
    public String doLoginWithInvalidDetails(String email, String pswrd)
    {
       ...
       // WebElement loginFailedText = EXTRA_EXPLICIT_WAIT.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//p[contains(text(),'Your email or password is incorrect!')]")));
